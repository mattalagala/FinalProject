  ...
  return knex('category').del()
    .then(function () {
      ...
      return knex('category').insert([
        {category_id: '0cc62b56-b8d9-4db0-b1e3-912b1a6c290e', category_name :'Project 1', category_description: 'test Description!', category_team_name: 'newTeamName', category_languages: 'JavaScript, React, SQL', category_picture: 'https://picsum.photos/620/620'},
